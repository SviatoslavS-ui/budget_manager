...
namespace budget_manager.Models
{
    public class ExpensesDataAcessLayer
    {
        ...
        public IEnumerable<ExpenseReport> GetAllExpenses()
        {
            ...
            {
                throw new Exception("Can`t get all records from db");
            }
        }
        ...
        {
            var exp = new List<ExpenseReport>();
            try
            {
            ...
            {
                throw new Exception("Can`t receive search results");
            }
        }
        ...
        public void AddExpense(ExpenseReport expense)
        {
            ...
            {
                throw new Exception("Can`t put new record to db");
            }
        }

        //To Update the records of a particular expense
        public int UpdateExpense(ExpenseReport expense)
        {
            ...
            {
                throw new Exception("Can`t update expense");
            }
        }
        ...
        public ExpenseReport GetExpenseData(int id)
        {
            ...
            {
                throw new Exception("Can`t get record data");
            }
        }
